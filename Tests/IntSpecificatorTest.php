...
class IntSpecificatorTest
{
    ...
    {
        return $this->isCatchedInvalidArgumentTypeException('Test String');
    }
    ...
    {
        return $this->buildQueryString(1.56, '1');
    }
    ...
    {
        return $this->buildQueryString('2.56', '2');
    }

    private function buildQueryString($bindings, string $expectedString): bool
    {
        $specificator = new IntSpecificator($bindings);
